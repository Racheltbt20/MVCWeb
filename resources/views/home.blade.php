...
@section('content') 
    <section class="jumbotron text-center">
        <img src="{{ ('img/kukang_selfie.jpg') }}" alt="aaa" width="200" class=" rounded-circle img-thumbnail">
        <h1 class="display-4">Rachel Tabita Noviyanti</h1>
        <p class="lead">12 RPL 1 | Absen 35</p>
    </section>
