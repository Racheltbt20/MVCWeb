...
<section id="about">
    <div class="container">
        ...
        <div class="row m-3 mb-5 text-center justify-content-center">
            <div class="col-md-4">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci nemo atque architecto nihil, ad expedita id. Vero est doloremque deserunt, iusto placeat qui nulla incidunt enim rem eaque dolores similique?</p>
            </div>
            <div class="col-md-4">
